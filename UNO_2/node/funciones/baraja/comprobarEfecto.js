const obtenerCartas = require('./obtenerCartas.js'); // Importa la función para obtener cartas del mazo
...
const comprobarJugabilidadMas2 = require('./comprobarJugabilidadMas2.js'); // Importa la función para comprobar si el jugador puede responder con un +2
